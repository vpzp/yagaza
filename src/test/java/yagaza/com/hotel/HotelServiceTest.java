...
class HotelServiceTest {
    ...
    @Test
    void testJpa(){
        //this.hotelService.create(123l, "asd");
    }
    @Test
    public void hotelNumberCrawling(){
        ...
        try {
            ...
            for (WebElement hotelElement : hotelElements){
                hotelService.createHrefName(hrefToId(hotelElement.getAttribute("href")), hotelElement.getAttribute("href"), hotelElement.getAttribute("title"));
            }
        }catch (Exception e){
    ...
    public void hotelCrawling(long placeId){
        ...
        String name, href, checkInTime, price, content, id;
        try{
            ...
            this.hotelService.createRegionImg(placeId, adress, imgElement);
            System.out.println("성공");
            ...
            for(Element element : hotelRoomElements){
                ...
                if(isLodgment(element)){
                    ...
                    content = element.getElementsByClass("css-1w8cj78").text();
                    id = href.replaceAll("/places/" + placeId +"/","");

                    hotelRoomService.create(id, name, href, checkInTime, price, content, placeId);
                }
            }
        }catch (Exception e) {
            e.printStackTrace();
